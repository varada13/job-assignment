...
/* Problem 3 :  Find the longest palindrome from the given string. palindrome is a word,phrase or 
 sequence that reads the same backwards as forwards ex: madam, civic, radar .
*/
